            ...
            <div className="container mx-auto my-12">
                <div className="hero my-6">
                    <div className="hero-content flex-col lg:flex-row">
                        <Image src={gif} alt="Profile Picture" className="max-w-sm rounded-lg border-2 border-yellow-800" />
                        <div className="lg:ml-6 text-center lg:text-left">
                            <h1 data-aos="fade-up" data-aos-duration="1000" className="text-5xl font-bold text-yellow-700 playfair">About Me</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 my-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-yellow-800">
                        <h2 className="text-3xl font-bold mb-4 text-yellow-700 playfair">Education</h2>
