...
const Services = () => {
    return (
        <div className="container mx-auto p-6 min-h-screen">
            <h1 className="text-5xl font-bold text-center text-yellow-700 my-12 playfair">Services I Provide</h1>
                ...
                <div key={idx} className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {category.services.map((service, index) => (
                            <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-3xl transition-shadow duration-300 flex flex-col items-center border-2 border-yellow-600">
