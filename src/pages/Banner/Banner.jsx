                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='text-center'>
                        ...
                        <div className='flex justify-center gap-10'>
                            <a href='https://drive.google.com/uc?export=download&id=11GzZOld_rZVT4TK-kGMUr_Nlnuq6ETzB' download="Humayra_Amin_Resume.pdf">
                                <button className="btn bg-gray-900 border-gray-900 text-white lg:text-xl md:text-xl playfair hover:bg-gray-700 hover:border-gray-700">
                                    <span><FaDownload /></span>Download Resume
                                </button>
                            </a>
                            <Link href={'/contact'}>
                                <button className="btn bg-gray-900 border-gray-900 text-white lg:text-xl md:text-xl  playfair hover:bg-gray-700 hover:border-gray-700"><span><MdOutlineContactPage /></span>Get In Touch</button>
                            </Link>
                        </div>
                    </div>
                </div>
